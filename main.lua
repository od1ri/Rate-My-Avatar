...
-- Оригинал: https://scriptblox.com/script/Rate-My-Avatar-TROLL-GUI-GUI-16252

-- t.me/itzperson хехеххе

local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Window = Library.CreateLib("Rate my Avatar | ТГК: @itzperson", "Synapse")
...
skullExplodeCond = true
	...
	while skullExplodeCond==true do
		...
		for _,v in pairs(skullExplodeTab) do
			local k={[1]="Update",[2]={["DescriptionText"]="Ain't no way💀",["ImageId"]=v}}
			game:GetService("ReplicatedStorage").CustomiseBooth:FireServer(unpack(k))
...
Section:NewToggle("Mewing", "cryniz#5446 , noxu#0001", function(state)
	...
	while pugCond==true do
		...
		for _,v in pairs(pugTab) do
			local k={[1]="Update",[2]={["DescriptionText"]="🤫🧏‍♂️",["ImageId"]=v}}
			game:GetService("ReplicatedStorage").CustomiseBooth:FireServer(unpack(k))
